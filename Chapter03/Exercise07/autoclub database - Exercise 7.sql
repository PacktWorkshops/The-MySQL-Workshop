CREATE DATABASE  IF NOT EXISTS `autoclub` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `autoclub`;
...
CREATE TABLE `clubevents` (
  ...
  `EventBlurb` mediumtext,
  `clubeventscol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `eventvenues` (
  ...
  `VenueAddress1` varchar(255) DEFAULT NULL,
  `VenueAddress2` varchar(255) DEFAULT NULL,
  `VenueTown` varchar(30) DEFAULT NULL,
  `VenueState` int(11) DEFAULT NULL,
  `VenuePostcode` varchar(10) DEFAULT NULL,
  `VenueContactName` varchar(20) DEFAULT NULL,
  `VenuePhone` varchar(15) DEFAULT NULL,
  `VenueEmail` varchar(255) DEFAULT NULL,
  `VenueWebsite` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `memberaddress` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `MemberID` int(11) NOT NULL,
  `StreetAddress1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `StreetAddress2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Town` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `State` int(11) NOT NULL,
  `Postcode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `WhenAdded` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `LastModified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `FK_Member_idx` (`MemberID`),
...
-- Dump completed on 2020-01-21 19:12:34
