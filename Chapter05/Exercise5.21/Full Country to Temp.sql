-- This SQL will import the full country list into a table named temp
-- MySQL dump 10.13  Distrib 8.0.17, for Win64 (x86_64)
--
-- Host: 192.168.0.3    Database: original_world_statistics
-- ------------------------------------------------------
...
ADD CONSTRAINT `ContinentID`
  ...
  REFERENCES `world_statistics`.`continents` (`ContinentID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
  
-- Create and Import data into table named temp
